...
// UpdateUserIdentityAndSelfieImage godoc
//
...
//	@Router			/user-detail/update-identity-and-selfie-image [put]
//	@Param			api_key	header string	true "Api Key"
//	@Param			file formData file	true "User image that will be saved to the database_model"
//	@Security		ApiKeyAuth
func UpdateUserIdentityAndSelfieImage(c *gin.Context) {
	upload_helper.UploadImageForKyc(c, "identity_and_selfie_images/")
}
